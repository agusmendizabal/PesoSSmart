      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        {backfillDone && (
          <View style={styles.backfillBanner}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={styles.backfillTitle}>¡Conectado! Importando historial...</Text>
              <Text style={styles.backfillSub}>Estamos importando tus gastos de los últimos 6 meses. Esto puede tomar un momento.</Text>
            </View>
          </View>
        )}
